export { createQuoter } from "./quoter.js";
export { loadPools, parsePools } from "./pools.js";
export { buildStateOverrides, getBalanceOverride } from "./overrides.js";
export { POOL_TYPE } from "./types.js";
import { readFileSync } from "node:fs";
import { join, dirname } from "node:path";
import { fileURLToPath } from "node:url";
const __dirname = dirname(fileURLToPath(import.meta.url));
/** Deployed HayabusaRouter address on Avalanche C-Chain */
const addressJson = JSON.parse(readFileSync(join(__dirname, "..", "data", "address.json"), "utf-8"));
export const ROUTER_ADDRESS = addressJson.address;
export const DEPLOYMENT_BLOCK = addressJson.block;
