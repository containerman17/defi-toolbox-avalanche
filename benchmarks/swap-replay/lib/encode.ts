...
import { type StoredPool, POOL_TYPE_UNIV4, POOL_TYPE_BALANCER_V3_BUFFERED, POOL_TYPE_TRANSFER_FROM, POOL_TYPE_V2, POOL_TYPE_BALANCER_V2, POOL_TYPE_CAVALRE, POOL_TYPE_KYBER_DMM, POOL_TYPE_SYNAPSE, POOL_TYPE_TRIDENT } from "../../../tools/pool-collector/types.ts";
