...
**98.8% correct** — 3929 match, 46 mismatch, 3975 tested quotes (2000 pools).
...
| Wombat/Platypus | 4 | No formula implementation (Wombat spec ready) |
| Balancer V3 3-token + GyroECLP | 4 | PoolQuoter interface only has zeroForOne bool |
