...
const opcodes: Record<number, string> = {
  ...
  0x16: "AND", 0x17: "OR", 0x18: "XOR", 0x19: "NOT", 0x1a: "BYTE", 0x1b: "SHL", 0x1c: "SHR",
  0x20: "SHA3", 0x30: "ADDRESS", 0x31: "BALANCE", 0x33: "CALLER", 0x34: "CALLVALUE",
  0x35: "CALLDATALOAD", 0x36: "CALLDATASIZE", 0x38: "CODESIZE",
  0x39: "CODECOPY", 0x3b: "EXTCODESIZE", 0x40: "BLOCKHASH", 0x42: "TIMESTAMP",
  0x43: "NUMBER", 0x45: "GASLIMIT", 0x50: "POP", 0x51: "MLOAD", 0x52: "MSTORE", 
  0x53: "MSTORE8", 0x54: "SLOAD", 0x55: "SSTORE", 0x56: "JUMP", 0x57: "JUMPI", 
  0x58: "PC", 0x59: "MSIZE", 0x5a: "GAS", 0x5b: "JUMPDEST",
  0xf0: "CREATE", 0xf1: "CALL", 0xf3: "RETURN", 0xf4: "DELEGATECALL",
...
function disasm(start: number, end: number) {
  let i = start;
  while (i < end) {
    const op = bytes[i];
    const name = opcodes[op] || `UNK(${op.toString(16)})`;
    if (op >= 0x60 && op <= 0x7f) {
      const size = op - 0x5f;
...
// What happens when direction=0 (selling USDC = buying base)
// At 0x0555, DUP4 = direction = 0, ISZERO = true, jumps to 0x0ad8
console.log("=== Code at 0x0ad8 (direction=0 path) ===");
disasm(0x0ad8, 0x0ad8 + 150);
