import { POOL_TYPE_ERC4626, POOL_TYPE_BALANCER_V3, POOL_TYPE_BALANCER_V3_BUFFERED, type StoredPool } from "./types.ts";
 ...
 */
export const ERC4626_VAULTS: StoredPool[] = [
  {
  ...
  {
    address: "0x45cf39eeb437fa95bb9b52c0105254a6bd25d01e", // waAvaAUSD
    providerName: "erc4626",
    poolType: POOL_TYPE_ERC4626,
    tokens: [
  ...
  {
    address: "0xa25eaf2906fa1a3a13edac9b9657108af7b703e3", // ggAVAX
    providerName: "erc4626",
    poolType: POOL_TYPE_ERC4626,
    tokens: [
      "0xb31f66aa3c1e785363f0875a1b74e27b85fd66c7", // WAVAX (underlying)
 ...
 */
export function generateBufferedEdges(pools: Iterable<StoredPool>): StoredPool[] {
  const edges: StoredPool[] = [];
  for (const pool of pools) {
    if (pool.poolType !== POOL_TYPE_BALANCER_V3) continue;
    ...
    for (const wi of wrapped) {
      for (const wo of wrapped) {
        ...
        edges.push({
          ...
          poolType: POOL_TYPE_BALANCER_V3_BUFFERED,
